/**
 * Horizontal I Tatti logo, shared with Libra: crimson mark + serif wordmark, inlined so it can
 * follow the theme. The wordmark uses currentColor (the page foreground); the mark uses
 * --itatti-crimson, which stays the true saturated institutional crimson — dark mode lifts it only
 * as far as visibility requires, because a text-accent tint would wash the brand colour out.
 */
