...
// Ported from Libra's customized shadcn sidebar so both portals share the same shell behaviour:
// the stock component plus a drag-resizable rail, localStorage persistence, i18n'd accessibility
// text (the registry hardcodes English), and a menu badge for the pending-approvals count.
export const SIDEBAR_STORAGE_KEY = "ferie-sidebar"
const SIDEBAR_WIDTH_STORAGE_KEY = "ferie-sidebar-width"
const SIDEBAR_WIDTH = "16rem"
const SIDEBAR_WIDTH_MOBILE = "18rem"
const SIDEBAR_WIDTH_ICON = "3.25rem"
const SIDEBAR_KEYBOARD_SHORTCUT = "b"
// Drag-resize band for the rail. The floor keeps every menu label fully readable in both
// languages; the ceiling stops the nav eating the content column.
...
/**
 * Positions a counter (e.g. the pending-approvals count) at the right edge of a menu row, outside
 * the button's truncating span. Hidden while the rail shows icons only, like the group labels.
 */
function SidebarMenuBadge({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute top-1/2 right-2 -translate-y-1/2 select-none",
